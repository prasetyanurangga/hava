class HavaModel {
  ...
  HavaModel({this.location, this.current, this.forecast});

  HavaModel.fromJson(Map<String, dynamic> json) {
...
class Forecast {
  ...
  Forecast.fromJson(Map<String, dynamic> json) {
    if (json['forecastday'] != null) {
      ...
      json['forecastday'].forEach((v) { forecastday.add(new Forecastday.fromJson(v)); });
    }
  }
...
class Forecastday {
  ...
  Forecastday.fromJson(Map<String, dynamic> json) {
    ...
    if (json['hour'] != null) {
      hour = new List<Hour>();
      json['hour'].forEach((v) { hour.add(new Hour.fromJson(v)); });
    }
  }
...
class Hour {
  ...
  Hour({this.timeEpoch, this.time, this.tempC, this.tempF, this.isDay, this.condition, this.windMph, this.windKph, this.windDegree, this.windDir, this.pressureMb, this.pressureIn, this.precipMm, this.precipIn, this.humidity, this.cloud, this.feelslikeC, this.feelslikeF, this.windchillC, this.windchillF, this.heatindexC, this.heatindexF, this.dewpointC, this.dewpointF, this.willItRain, this.chanceOfRain, this.willItSnow, this.chanceOfSnow, this.visKm, this.visMiles, this.gustMph, this.gustKph});
